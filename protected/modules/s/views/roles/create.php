...
<?php
$this->menu=array(
    array('label'=>'نقش مدیران', 'url'=>array('admin')),
    array('label'=>'مدیریت مدیران', 'url'=>array('manage/admin')),
);

$this->renderPartial('_form', array('model'=>$model,'title'=> 'افزودن نقش جدید')); ?>