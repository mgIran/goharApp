...
class UnityManageController extends Controller
{
	/**
	...
	public function actionCreate()
	{
		...
		$posterDIR = Yii::getPathOfAlias("webroot") . "/uploads/unity/";
		if (!is_dir($posterDIR))
			mkdir($posterDIR);
		...
		if (isset($_POST['Unity'])) {
			...
			if (isset($_POST['Unity']['poster'])) {
				$file = $_POST['Unity']['poster'];
				$poster = array(
					'name' => $file,
					'src' => $tmpUrl . '/' . $file,
	...
	public function actionUpdate($id)
	{
		...
		if (!is_dir($posterDIR))
			mkdir($posterDIR);
		$posterUrl = Yii::app()->baseUrl . '/uploads/unity/';
		...
		if (isset($_POST['Unity'])) {
			...
			if (isset($_POST['Unity']['poster']) and file_exists($tmpDIR . $_POST['Unity']['poster'])) {
				$file = $_POST['Unity']['poster'];
				$poster = array(
					'name' => $file,
					'src' => $tmpUrl . '/' . $file,
	 ...
	 * @param Unity $model the model to be validated
	 */
