...
class Users extends iWebActiveRecord
{
    ...
    public function rules()
    {
        ...
        return array(
            ...
            array('card_number', 'validateCardBankLength', 'except' => 'upload, changePassword, app_insert, app_update, update'),
    ...
    public function userInfoStatus($validateOld = TRUE, $clear = FALSE)
    {
        ...
        $this->userInfoClear();/*$model = new UsersOptions;
    ...
    {
        if($type == 'avatar'){
            $path = Yii::getPathOfAlias('webroot') . self::$avatarPath;
