...
<?php $form = $this->beginWidget('CActiveForm', array(
	...
	<div class="row rememberMe">
        ...
        <a href="<?=Yii::app()->createAbsoluteUrl('users/login/forgetPassword')?>" class="forget-pass pull-left" title="فراموشی رمز عبور">رمز عبور را فراموش کرده ام</a>
	</div>
