<?php
class MessagesMobilesBankCategories extends iWebActiveRecord
{
	public function tableName()
	{
        return '{{messages_mobiles_bank_categories}}';
	}
	...
	{
		return array(
			'parent' => array(self::BELONGS_TO, 'MessagesMobilesBankCategories', 'parent_id'),
            'children' => array(self::HAS_MANY, 'MessagesMobilesBankCategories', 'parent_id'),
		);
	}
