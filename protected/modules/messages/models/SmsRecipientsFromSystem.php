...
/**
 * This is the model class for table "{{sms_recipients_from_system}}".
 *
 * The followings are the available columns in table '{{sms_recipients_from_system}}':
 * @property integer $id
 ...
 * @property Sms $sms
 */
class SmsRecipientsFromSystem extends CActiveRecord
{
	public $tableLabel;
	/**
	...
	{
		return '{{sms_recipients_from_system}}';
	}
	 ...
	 * @return SmsRecipientsFromSystem the static model class
	 */
