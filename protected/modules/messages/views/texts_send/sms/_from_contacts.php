            ...
            <div class="modal-body">
                <div class="form">
                    ...
                    'function(e){
                        ...
                        $("#MessagesTextsSend_contacts").val(JSON.stringify(selectedElmsIds));

                    }';
                    $this->widget('application.modules.messages.extensions.RolesJsTree.RolesJsTree', array(
                        'name' => 'MessagesTextsSend[contacts]',
                        'classes' => $contactsCategories,
                        'id' => 'contactsTree',
                        'inputId'=>'MessagesTextsSend_contacts',
                        'itemsPrefixId' => 'contacts_text' ,
                        'ajax' =>
                            "'data' : {
                                'dataType' : 'JSON',
                                'url' : function (node) {
                                    return node.id === '#' ?
                                        '".Yii::app()->createAbsoluteUrl("messages/texts_send/getContactsCategories")."' :
                                        '".Yii::app()->createAbsoluteUrl("messages/texts_send/getContacts?id=")."' + node.id;
                                    }
                                }
                            ",
                        'onChanged' => $js,
