...
Yii::app()->clientScript->registerScript('uploadFile',"
    ...
    $('#MessagesEmailsBank_cat_id li').on('click',function(){
    ...
    <div class="modal-dialog" style="width: 350px;">
        <div class="modal-content col-md-12">
            <div class="modal-header">
                ...
                <h4 class="modal-title">ثبت ایمیل به بانک از طریق آپلود فایل</h4>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 pull-right">
                            <?php $this->widget('ext.iWebDropDown.iWebDropDown', array(
                                ...
                                'label'=>'انتخاب کنید',
                                'name'=>'MessagesEmailsBank[cat_id]',
                                'id'=>'MessagesEmailsBank_cat_id',
                                'list'=> $categories,
