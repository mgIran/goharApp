<div class="modal fade" id="from-email-bank" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
            ...
            <div class="modal-body">
                <div class="form">
                    ...
                    $this->widget('application.modules.messages.extensions.RolesJsTree.RolesJsTree', array(
                        'name' => 'MessagesEmailsSend[bank]',
                        'classes' => $emailsBankCategories,
                        'id' => 'emailsBankTree',
                        'itemsPrefixId' => 'bank_email' ,
                        'inputId' => 'MessagesEmailsSend_bank',
                        'isBank' => TRUE
                    ));
                    ?>
                </div>
