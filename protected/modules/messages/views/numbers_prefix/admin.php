...
$this->menu=array(
    array('label'=>'افزودن پیش شماره', 'url'=>array('create')),
);
?>

<h1>مدیریت پیش شماره ها</h1>

<?php $this->widget('zii.widgets.grid.CGridView', array(
    'id'=>'messages-texts-numbers-prefix-grid',
    ...
    'columns' => array(
        ...
        array(
            'name' => 'status',
            'value' => 'MessagesTextsNumbersPrefix::$statusList[$data->status]',
        ),
        array(
            'class'=>'CButtonColumn',
